 ...
 */
contract TiktInitialOffering is Ownable {
    ...
    uint public START;
    uint public END;
    uint public constant TOTAL_DISTRIBUTE_AMOUNT = 250_000_000e18;
    uint public constant MINIMAL_PROVIDE_AMOUNT = 50_000 ether;
    uint public constant MAXIMAL_PROVIDE_AMOUNT = 80_000 ether;
    uint public constant MAX_PER_USER = 1000 ether;
    uint public constant H_To_T = 5000;
    ...
    function claim() external nonReentrant {
        ...
        if(totalProvided >= MINIMAL_PROVIDE_AMOUNT) {
            tokenAmount = TOTAL_DISTRIBUTE_AMOUNT
                .mul(userShare)
                .div(totalProvided);
        } else {
            tokenAmount = userShare * H_To_T;
        }
